...
export default function LoginForm({ onSwitch }) {
  ...
  window.location.href = authAPI.getOAuthUrl('github');
}
...
<div className="flex flex-col gap-2">
  ...
  <button
    ...
    className="flex items-center justify-center gap-3 bg-[#24292e] hover:bg-[#1a1e22] border-2 border-[#24292e] rounded-lg py-2.5 font-nunito text-[14px] font-bold text-white transition-all duration-200"
  >
